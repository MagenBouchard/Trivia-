$(document).ready(function() {
  let questionBank = [
    ...
    {
      prompt:
        "How many breeds of dogs are recognized by the American Kennel Club(AKC)?",
    ...
    {
      prompt:
        "How many years has the Labrador Retriever been pn the AKC's top 10 most popular breed list?",
      choices: [
        "2 Consecutive years",
        "5 Consecutive years",
...

    {
      ...
      answer: 2,
      photo:
        "https://vetstreet-brightspot.s3.amazonaws.com/00/2ec490a80611e0a0d50050568d634f/file/Shipperke-3-645mk062811.jpg"
    },
    {
      prompt:
        "According to the AKC what is the weight range of an Airedale Terrier?",
  ...
  function hidePic() {
    ...
    setTimeout(function() {
      ...
      if (wrongAnswers + correctAnswers === total) {
        ...
        $("#answer").append(
          "<h4>" + "Number of Wrong: " + wrongAnswers + "</h4>"
        );
        $("#nextQuestion").show();
        correctAnswers = 0;
        wrongAnswers = 0;
